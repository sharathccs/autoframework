...
public class ExampleForSwitchToFrame {
	public static WebDriver driver;
	final static Logger logger = Logger.getLogger(ExampleForSwitchToFrame.class);
	...
	public void beforeMethod() throws Exception { 
			...
			driver.get(Constants.UrlWithIFrame_URL);
	...
	public void iFrameExampleTest() throws Exception {
		...
		iFrameHomePage._SwitchToiFrame(driver, "ossn");
		iFrameHomePage._SwitchToiFrame(driver, "sai");
